...
public class SplashScreenManager {
  ...
  private static final LoadingStep[] steps = {
      new LoadingStep(((ImageIcon) IconFactory.getIcon("pictures-32x32.png"))
          .getImage(), "Loading saved albums ..."),
      new LoadingStep(((ImageIcon) IconFactory.getIcon("paint-32x32.png"))
          .getImage(), "Building graphical interface ...") };
